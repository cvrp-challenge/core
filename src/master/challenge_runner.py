...
# Project path setup
# ---------------------------------------------------------
CURRENT = Path(__file__).parent         # src/master/
SRC_ROOT = CURRENT.parent               # src/
PROJECT_ROOT = SRC_ROOT.parent          # core/
...
def solve_instance_probabilistic(
    ...
    try:
        ...
        _log_run_configuration(
            ...
            routing_solvers=routing_solvers or ["pyvrp", "filo1", "filo2", "ails2"],
...
def main():
    ...
    parser.add_argument("--time_limit_total", type=float, default=36000.0)
