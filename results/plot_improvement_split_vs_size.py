#!/usr/bin/env python
"""
Plot per-instance improvement-source split vs instance size.

Y-axis: percentage (0-100)
X-axis: instance size
...
DEFAULT_OUT = ROOT / "results" / "out" / "improvement_split_vs_instance_size.png"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=DEFAULT_OUT,
        help="Output image path (default: results/out/improvement_split_vs_instance_size.png)",
    )
    ...
    ax.set_title("Improvement-source split vs instance size")
