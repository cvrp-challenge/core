#!/usr/bin/env python
"""
Scatter plot: instance size (from instances_characteristics.json) vs
...
DEFAULT_OUT = ROOT / "results" / "out" / "gap_vs_instance_size.png"
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=DEFAULT_OUT,
        help="Output image path (default: results/out/gap_vs_instance_size.png)",
    )
    ...
    with SUMMARY_PATH.open(encoding="utf-8", newline="") as f:
        ...
        for row in reader:
            ...
            sizes.append(int(chars[key]["size"]))
    ...
    ax.set_title("Gap to best known solution vs instance size")
